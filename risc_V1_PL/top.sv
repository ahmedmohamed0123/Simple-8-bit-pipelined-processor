...
// *********** outputs to WB stage ************
	...
	assign Mem_W_D = w_Data_S_M_MEM ? Pc_plus1_MEM : Mux1 ;

	assign Mem_Add = w_Add_S_M_MEM ? ALU_out_MEM : Imm_MEM ;
    ...
    MEM_WB_Register MEM_WB(           	   
		  .clk(clk),
          .rst_n(rst_n),
          .stall(stall),      // Stall signal to freeze p
          .flush(flush),      // Flush signal to clear pi        
          .alu_out_MEM(Alu_out_MEM),
